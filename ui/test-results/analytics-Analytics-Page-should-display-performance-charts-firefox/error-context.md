      ...
      - application:
        - list:
          - listitem:
            ...
            - text: Έσοδα
        - application: JanFebMarAprJun0900018000
      ...
      - application:
        - list:
          - listitem:
            ...
            - text: Μετατροπή %
        - application: JanFebMarAprJun048
      ...
      - application:
        - list:
          - listitem:
            - img "AOV legend icon"
            - text: AOV
        - application: JanFebMarAprJun060120
...
- button "Pause"
- button "Clear"
- text: "Renders: 1 Avg: 26.0ms Performance Score 0%"
- progressbar
- text: "1 slow renders detected Last render: 12:46:55 PM"
```